...
export declare const displayAndBoxModel: {
    ...
    readonly gridTemplateColumns: true;
    readonly gridTemplateRows: true;
    readonly flex: true;
...
export declare const borders: {
    ...
    readonly borderRightWidth: true;
    ...
    readonly borderBottomWidth: true;
